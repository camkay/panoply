...
<!-- [![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/camkay/panoply?branch=master&svg=true)](https://ci.appveyor.com/project/camkay/panoply) -->
[![Codecov test
